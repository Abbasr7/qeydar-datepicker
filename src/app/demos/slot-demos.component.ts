...
@Component({
    ...
    <section class="slot-showcase">
      <div class="showcase-heading">
        <div>
          ...
          <p>Toolbar, header, footer, and body slots — all backed by the same date-selection logic.</p>
        </div>
      ...
      <div class="demo-grid">
        <article class="demo-card quick-card">
          ...
          <p class="card-copy">Give frequent choices a place above the calendar and keep confirmation actions close at hand.</p>
        ...
        <article class="demo-card hero-card">
          ...
          <p class="card-copy">Replace the compact chrome with a strong date summary while the calendar body stays familiar.</p>
        ...
        <article class="demo-card wheel-card">
          ...
          <p class="card-copy">The body slot can own the whole calendar surface — perfect for a compact spinner or wheel picker.</p>
  ...
  styles: [`
    ...
    .slot-showcase {
      ...
      border-radius: 24px;
      background: linear-gradient(145deg, #f8faff 0%, #f2f5fb 52%, #eef2f9 100%);
      color: var(--ink);
      box-shadow: 0 18px 42px rgba(27, 47, 86, .08);
    }
    ...
    .demo-card {
      min-width: 0;
      overflow: hidden;
      border: 1px solid rgba(222, 228, 239, .95);
      border-radius: 18px;
      background: rgba(255, 255, 255, .78);
      box-shadow: 0 12px 26px rgba(34, 54, 94, .06);
    }
    ...
    .reference-picker ::ng-deep .date-picker-popup {
      ...
      border-radius: 15px;
      background: #fff;
      box-shadow: 0 12px 24px rgba(36, 51, 85, .1);
    }
    ...
    .primary-action {
      ...
      color: #fff;
      box-shadow: 0 5px 10px rgba(68, 104, 239, .22);
    }
